...
<input style="height: 350px;width:900px;padding-bottom: 8px;" type="image" src="assets/images/medi12.JPG" >
  ...
  <b> At Your Home</b> </h1>
      ...
      <h2 style="margin-left: 270px;"> LOGIN </h2>
       <fieldset> <label><b>Email &nbsp;&nbsp;&nbsp;&nbsp; </b></label>
      ...
      <div class="footer-row">
        <div class="col-md-4 footer-grids">
          ...
          <ul>
            ...
            <li><a href="products.php"><i class="fa fa-arrow-right" aria-hidden="true"></i> Products</a></li>
            <li><a href="icons.php"><i class="fa fa-arrow-right" aria-hidden="true"></i> Web Icons</a></li>
            <li><a href="codes.php"><i class="fa fa-arrow-right" aria-hidden="true"></i> Short Codes</a></li>
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="footer-left">
        <!-- <p>© 2020 Medi Plus . All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p> -->
        Copyright © 2020 Online Medicine Order. All rights reserved.    
      </div>
